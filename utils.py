...
GLOBAL_CHECKPOINTS_FOLDER = os.path.join(ext, "lib_bopb2l", "Global", "checkpoints", "restoration")
FACE_CHECKPOINTS_FOLDER = os.path.join(ext, "lib_bopb2l", "Face_Enhancement", "checkpoints")
DAT = os.path.join(ext, "lib_bopb2l", "Face_Detection", "shape_predictor_68_face_landmarks.dat")
